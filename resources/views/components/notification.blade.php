...
<div x-cloak x-data="{ showInfo: false, message: '' }"
    ...
    <div class="w-full flex flex-col items-center space-y-4 sm:items-end">
        ...
        <div x-show="showInfo" x-transition:enter="transform ease-out duration-300 transition"
             x-transition:enter-start="translate-y-2 opacity-0 sm:translate-y-0 sm:translate-x-2"
             x-transition:enter-end="translate-y-0 opacity-100 sm:translate-x-0"
             x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100"
             x-transition:leave-end="opacity-0"
...
@if (session()->has('success'))
    <div x-cloak x-data="{ show: true }" aria-live="assertive"
         class="fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start">
        <div class="w-full flex flex-col items-center space-y-4 sm:items-end">
            <div x-show="show; setTimeout(() => { show = false }, 7000)"
